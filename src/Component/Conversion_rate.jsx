...
const steps = [
  ...
  {
    number: "5",
    title: "Mobile and SEO Optimization",
    description:
      "Mobile shoppers dominate e-commerce. Our E-Commerce Development creates responsive stores that shine on any device, improving engagement. SEO-optimized pages boost Google rankings, driving 20% more traffic to grow your reach and sales.",
    icon: BarChart3,
  },
  {
    number: "6",
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "A well-built store drives sales through optimized checkouts, personalized features, and fast performance. SEO enhancements attract more visitors, while mobile designs capture on-the-go shoppers. Our E-Commerce Development integrates tools like analytics and CRMs to target customers effectively, increasing conversions and ROI. ",
  },
];
    ...
    <div className=" bg-white overflow-x-hidden pt-18 sm:pt-18">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                ...
                <p className="text-teal-700 leading-relaxed text-sm sm:text-base lg:text-lg">
                  ...
                  SEO Optimization for E-Commerce We optimize product pages,
      ...
      <section className="bg-white  sm:py-16 lg: px-4 sm:px-6 lg:px-8">
        ...
        >
          <FloatingElement>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-teal-700 mb-4 sm:mb-6">
              Why Conversion Rate OPtimization(CRO) Businesses Need Marketing Services
            </h2>
          </FloatingElement>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-teal-50/30 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          <FloatingElement>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-teal-700 mb-4 sm:mb-6">
              Our Conversion Rate OPtimization(CRO) Process
            </h2>
          </FloatingElement>
          ...
          <div className="text-center mb-8 sm:mb-12">
            <FloatingElement>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-teal-700 mb-4">
                Benefits of Professional Conversion Rate OPtimization(CRO)
              </h2>
            </FloatingElement>
