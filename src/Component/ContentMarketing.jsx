...
import seo2 from "../images/cm00.jpeg";
import seoImage from "../images/cm1.png";
import seo4 from "../images/cm2.png";
import aboutImg from "../images/cm3.png";

import ppc1 from "../images/cm001.jpeg";
import ppc2 from "../images/cm002.jpeg";
import ppc3 from "../images/cm003.jpeg";
import ppc4 from "../images/cm004.jpeg";
...
const stepss = [
  {
    ...
    title: "Research",
    description:
      "Deep dive into your industry, competitors, and target keywords to uncover CONTENT MARKETING opportunities.",
  ...
  },
  {
    ...
    title: "Strategy",
    description:
      "Develop a customized CONTENT MARKETING strategy based on our research findings to maximize visibility and ROI.",
  ...
  },
  {
    ...
    description:
      "Execute on-page, off-page, and technical CONTENT MARKETING improvements for measurable growth.",
...
const advantages = [
  ...
  },
  {
    ...
    description:
      "Tired of pouring money into ads with fleeting results? Our CONTENT MARKETING-optimized Content Marketing Service boosts your website’s ranking, bringing in a steady stream of organic visitors who are actively searching for what you offer.",
    icon: BarChart3,
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We specialize in CONTENT MARKETING, CONTENT MARKETING, social media marketing, and local CONTENT MARKETING to help expand your audience and connect with the right customers.",
  },
  {
    question:
      "How long does it take to see results fromContent Marketing Services?",
    answer:
      "Typically, CONTENT MARKETING results take 3-6 months, Content Marketing Services while CONTENT MARKETING and social media campaigns can generate leads almost immediately.",
  },
  {
  ...
  const seoPackages = [
    {
      ...
      duration: "/month",
      features: [
        "Content strategy consultation (1 session/month)",
        "4 blog articles per month (up to 800 words each)",
        "Content content marketing optimization",
        "Stock images & basic graphic design",
    ...
    },
    {
      ...
      popular: true,
      features: [
        "Comprehensive content strategy (blogs, visuals, videos)",
        "8–10 content marketing-optimized articles per month (up to 1200 words)",
        "Keyword-driven topic research",
        "Content distribution across social & blog channels",
    ...
    },
    {
      ...
      duration: "/month",
      features: [
        "Full-scale content marketing management",
        "Unlimited articles, infographics & video scripts",
        "Brand storytelling & authority building",
        "Email newsletter creation & automation",
        "Weekly content strategy calls",
        "Advanced analytics & content performance insights",
        "Dedicated content strategist & creative team",
        "Custom brand voice & tone development",
      ],
      ...
      <div className="bg-gray-50">
        ...
        <div className="py-16 px-6 md:px-12 lg:px-20">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 mb-20">
            ...
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Why content marketing is the Best Investment for Your Business
              </h2>
          ...
          <div className="bg-white py-16 px-6 md:px-12 lg:px-20 text-center">
            ...
            <div className="max-w-4xl mx-auto mb-12">
              ...
              <p className="text-gray-600 mt-3">
                At DigLip 7, our content marketing process is designed to deliver measurable results. We begin with audience research and strategy planning, create high-quality, engaging content, and optimize it for content marketing. Continuous performance tracking and refinement ensure maximum reach, traffic, and conversions for your business.
          ...
          <div className="bg-gray-50 py-16 px-6 md:px-12 lg:px-20">
            <div className="max-w-6xl mx-auto text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                Proven content marketing Success Stories
              </h2>
              <p className="text-gray-600 mt-3">
                Discover how DigLip 7 helped businesses achieve remarkable growth through content marketing.<span className="font-semibold text-teal-600">DigLip7</span>  From increasing website traffic to generating high-quality leads, our data-driven strategies deliver measurable results, boost brand authority, and maximize ROI for every client.
            ...
            >
              ...
              <div className="flex-1 space-y-4">
                ...
                <p className="text-sm text-gray-600">
                  Transformed a struggling tech startup into an industry leader through advanced CONTENT MARKETING.
                </p>
        ...
        <div className="bg-white py-16 px-6 md:px-12 lg:px-20">
          <div className="max-w-6xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Our CONTENT MARKETING Services</h2>
            <p className="text-gray-600 mb-10">
              Content Marketing services designed to maximize ROI and drive targeted traffic.
            </p>
        ...
        <div className="bg-gray-50 py-16 px-6 md:px-12 lg:px-20">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Content marketing Packages Designed for Every Stage</h2>
            <p className="text-gray-600 mb-10">
              Choose the perfect CONTENT MARKETING package that fits your business needs and budget.
            </p>
              ...
              >
                ...
                <p className="text-teal-700 leading-relaxed text-sm sm:text-base lg:text-lg">
                  ...
                  <span className="font-semibold text-[#c89d5a]">
                    CONTENT MARKETING, CONTENT MARKETING, social media marketing, and local CONTENT MARKETING
                  </span>
          ...
          {advantages.map((adv, index) => (
            ...
            >
              <Card3D className="h-full">
                <div className="bg-gradient-to-br from-teal-900 to-teal-600 p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 h-full flex flex-col">
