  ...
  const team = [
    ...
    },
    {
    ...
    },
     {
      ...
      role: "Fullstack Develope | 1 Years Experiencer",
      img: t6,
  ...
  const contacts = [
    {
      ...
      title: "Headquarters",
      desc: "Address: C117, C Block, Sector 2 Noida, Uttar Pradesh",
    },
    {
  ...
  return (
    <div className=" bg-white lg:pt-20">
      ...
      <div className="bg-white text-center mb-10">
        ...
        <p className=" bg-white text-gray-600 mt-2">
          Our core beliefs and principles that guide every decision we make
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 dark:bg-white">
        {[
          ...
          <div key={index} className="bg-teal-700 text-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group dark:bg-white">
            ...
            <a
              href={service.href}
              className="inline-flex items-center gap-2 text-[#c89d5a] hover:text-[#276562] dark:text-white dark:hover:text-white font-medium   transition-colors duration-200"
            ><button className="px-4 py-6 group px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-teal-700 to-teal-900 text-white text-lg font-semibold rounded-full shadow-2xl hover:shadow-teal-500/50 transition-all duration-300 transform hover:scale-105">Learn More</button>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-20 text-center dark:bg-white">
        <motion.h2
          initial={{ opacity: 0, y: -20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 dark:bg-white"
        >
          IndustryRecognition
        </motion.h2>
        <motion.p
        ...
        >
          Awardsand certifications that validate our expertise
        </motion.p>


        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 dark:bg-white">
          {[
      ...
      <div className="bg-gray-50 text-gray-800">
        ...
        <div className="relative bg-gradient-to-r from-teal-700 via-teal-600 to-teal-500 text-white py-16 px-6 sm:px-12 lg:px-20 text-center">
          ...
          >
            <span className="px-3 py-1 text-xs bg-white/20 rounded-full mb-4 inline-block">
              ✦ Join 250+ Growing Businesses
            </span>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="/contact">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-4 py-6 group px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-teal-700 to-teal-900 text-white text-lg font-semibold rounded-full shadow-2xl hover:shadow-teal-500/50 transition-all duration-300 transform hover:scale-105"
                >
                  Start Your Growth Journey
                </motion.button></a>
              <input
                ...
                className="px-4 py-6 group px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-teal-700 to-teal-900 text-white text-lg font-semibold rounded-1/2 shadow-2xl hover:shadow-teal-500/50 transition-all duration-300 transform hover:scale-105"
              />
            </div>
