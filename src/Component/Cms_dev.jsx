...
import seo2 from "../images/cms.jpeg";
...
const solutions = [
  ...
  },
  {
    ...
    description: "Seamlessly transition from outdated systems to modern CMS platforms without losing data or SEO rankings.",
    icon: Link2,
    points: [
...
const faqs = [
 {
      ...
      answer:
        "Engagement can spike quickly—sometimes within days—especially through social media and email campaigns. However, SEO results from our Content Marketing Service typically take 3 to 6 months to fully develop. This timeline allows for consistent content creation, keyword optimization, and link-building, which are essential for sustainable search engine ranking growth.",
    },
    {
        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          >
            ...
            <p className="text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8">
              In today’s fast-paced digital landscape, businesses need websites that are easy to update, SEO-friendly, and secure. A CMS enables non-technical teams to manage content efficiently while providing developers with the flexibility to customize functionality. There are two primary types of CMS solutions:
            </p>
            <p className="text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8">
              Custom CMS
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                ...
                <p className="text-teal-700 leading-relaxed text-sm sm:text-base lg:text-lg">
                  Scalable, SEO-Ready, and Secure Solutions{" "}
