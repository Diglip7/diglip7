...
const advantages = [
  {
    title: "Superior Strategy & Data-Driven Execution",
    description:
      "Holistic Marketing Integration: Seamlessly blend SEM, PPC, and paid social strategies for unified campaign performance. Actionable Insights: Our data-driven approach ensures every decision is tailored to your business goals.",
    icon: TrendingUp,
  },
  {
    title: "Unmatched Expertise in Paid Advertising",
    description:
      "Platform Mastery: From Google Ads to TikTok, we stay ahead of trends to ensure peak performance. Conversion-Centric Focus: We optimize for conversions, not just clicks.",
    icon: BarChart3,
  },
  {
    title: "Transparent, Client-First Approach",
    description:
      "You Own Your Account: Full control and clarity over your PPC account. Clear Communication: Reports in plain language keep you in the loop.",
    icon: Search,
  },
  {
    title: "Proven Success",
    description:
      "With a track record of –28% decrease in cost-per-lead and +40% increase in CTR, our results speak for themselves.",
    icon: Handshake,
  },
];
...
const solutions = [
  {
    ...
    description: "Drive qualified leads with optimized search ads on Google,",
    icon: ShoppingCart,
    points: [
      "Bing, and more.",
      "Optimized Campaigns: Lower CPC, higher conversions.",
  ...
  },
  {
    ...
    description:
      "Engage your audience on Facebook, Instagram, LinkedIn, and TikTok.",
    icon: Building2,
    points: [
      "Interactive Ads: Creative campaigns that resonate.",
  ...
  },
  {
    ...
    description: "Reconnect with visitors to turn curiosity into conversions.",
    icon: MapPin,
    points: [
      "Cost-Effective: Target warm leads for better ROI.",
  ...
  },
  {
    ...
    description:
      "Broaden your reach with eye-catching visuals on Google’s display network.",
    icon: Link2,
    points: [
  ...
  },
  {
    ...
    description: "Build conversion-driven landing pages with A/B testing.",
    icon: HelpCircle,
    points: [
      "Tailored Design: Maximize click-to-customer rates.",
  ...
  },
  {
    ...
    description: "Fine-tune your customer journey for higher conversions.",
    icon: Mic,
    points: [
      "Holistic Enhancements: Lower costs, boost results.",
...
const steps = [
  {
    ...
    description:
      " Your PPC account is a prized asset. We empower you with full control and detailed insights, so you always know where your investment stands.",
    icon: Target,
  },
  {
    number: "2",
    ...
    description:
      "We concentrate on what matters most—conversions. Our goal is not to chase vanity metrics, but to drive leads, sales, and measurable business growth.",
    icon: Search,
  },
  {
    number: "3",
    ...
    description:
      "Forget technical jargon. Our reports are clear, concise, and focused on the metrics that matter to your business.",
    icon: Zap,
  },
  {
    number: "4",
    ...
    description:
      "Our PPC campaigns are designed to work in harmony with your broader digital marketing efforts, including SEO, content marketing, and conversion optimization.",
    icon: Globe,
  },
  {
    number: "5",
    ...
    description:
      " Experience the freedom of a month-to-month arrangement with just a 30-day notice for cancellation. We earn your trust through performance, not contract obligations.",
    icon: BarChart3,
  },
  {
    number: "6",
    title: "Manual, Hands-On Management",
    description:
      "We don’t leave your campaigns on autopilot. Our experts actively manage and fine-tune your PPC strategies daily or weekly to ensure optimal performance.",
    icon: Award,
  },
];
...
const faqs = [
  {
    ...
    answer:
      "PPC is the use of online channels to promote your products and services. It helps businesses increase visibility, attract potential customers, and boost sales.",
  },
  {
  ...
  {
    question:
      "Why should I hire a PPC instead of doing it myself?",
    answer:
  ...
  },
  {
    ...
    answer:
      "PPC campaigns are designed to work in harmony with your broader digital marketing efforts, visibility on search engines, driving organic traffic and increasing your chances of reaching customers.",
  },
];
    ...
    <div className="w-full  bg-white ">
      ...
      <section className="w-full bg-gradient-to-b from-white to-gray-50 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          >
            <div className="w-full w-full h-full sm:w-full sm:h-full lg:w-full lg:h-full">
          ...
          >
            ...
            {/* Why Choose diglip7 for Your PPC Needs? */}
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base lg:text-lg">
                  ...
                  Superior Strategy & Data-Driven Execution: Holistic Marketing
                  Integration: Seamlessly blend SEM, PPC, and paid social
                  strategies for unified campaign performance.
                </p>
              </motion.div>
              ...
              >
                <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-teal-600 mt-1 flex-shrink-0" />
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base lg:text-lg">
                  Unmatched Expertise in Paid Advertising: Platform Mastery:
                  From Google Ads to TikTok, we stay ahead of trends to ensure
                  peak performance. Conversion-Centric Focus: We optimize for
      ...
      <section className="bg-white py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 text-sm sm:text-base lg:text-lg max-w-3xl mx-auto leading-relaxed">
            At diglip7, our comprehensive PPC services are built on superior
            strategy, unmatched expertise, and a transparent, client-first
      ...
      <section className="bg-gradient-to-br from-gray-50 to-teal-50/30 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          <FloatingElement>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-teal-700 mb-4 sm:mb-6">
              Our Full Suite of PPC Services
            </h2>
          </FloatingElement>
          <p className="text-gray-600 max-w-4xl mx-auto text-sm sm:text-base lg:text-lg leading-relaxed">
            Explore Our Comprehensive PPC Solutions From strategy to execution,
            our services cover every aspect of paid advertising.
          </p>
        </motion.div>
          ...
          <div className="text-center mb-8 sm:mb-12">
            <FloatingElement>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-teal-700 mb-4">
                Our Proven PPC Management Approach
              </h2>
            </FloatingElement>
      ...
      {/* CTA Section */}
      <section className="w-full py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-teal-700 to-[#c89d5a] overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="w-full z-10 max-w-4xl mx-auto text-center px-4 sm:px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto">
              Join 1000+ businesses that have accelerated their growth with
              Diglip7. Let's create your success story together.
            </p>
