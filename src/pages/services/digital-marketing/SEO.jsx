    ...
    <div className="  w-full bg-white ">
          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 mb-20">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <ul className="text-gray-800 space-y-2 text-left mx-auto md:mx-0">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-teal-600 shrink-0" /><span>Cost-Effective Growth</span></li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-teal-600 shrink-0" /><span>Increased Visibility</span></li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-teal-600 shrink-0" /><span>Better User Experience</span></li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-teal-600 shrink-0" /><span>Higher ROI</span></li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-teal-600 shrink-0" /><span>Brand Trust</span></li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-teal-600 shrink-0" /><span>Sustainable Results</span></li>
              </ul>
            </div>
          </div>
      ...
      <section className="bg-gradient-to-r from-purple-50 via-purple-50 to-pink-50 py-20 px-4 sm:px-8">
        ...
        <div className="max-w-6xl mx-auto text-center mb-20">
          ...
          <motion.div
            key={activeIndex}
            className="bg-white shadow-xl rounded-2xl p-6 md:p-10 mx-auto max-w-3xl border border-gray-100"
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.6 }}
          >
            <Quote className="text-teal-600 w-10 h-10 mx-auto mb-4" />
            <p className="text-gray-700 italic mb-6 leading-relaxed">{testimonials[activeIndex].quote}</p>
          ...
          <div className="flex justify-center mt-8 gap-4 flex-wrap">
            {testimonials.map((t, i) => (
              <motion.button
                key={i}
                className={`p-2 rounded-full border-2 ${activeIndex === i ? "border-blue-500 scale-110" : "border-gray-300"
