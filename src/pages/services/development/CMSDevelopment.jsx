...
import aboutImg from "../../../images/cms3.png";

import ppc1 from "../../../images/cms001.png";
import ppc2 from "../../../images/cms002.png";
import ppc3 from "../../../images/cms003.png";
import ppc4 from "../../../images/cms004.png";
...
const stepss = [
  {
    ...
    title: "Research",
    description:
      "Deep dive into your industry, competitors, and target keywords to uncover CMS Development opportunities.",
  ...
  },
  {
    ...
    title: "Strategy",
    description:
      "Develop a customized CMS Development strategy based on our research findings to maximize visibility and ROI.",
  ...
  },
  {
    ...
    description:
      "Execute on-page, off-page, and technical CMS Development improvements for measurable growth.",
...
const caseStudies = {
  "TechStart Inc.": {
    title: "Digital artwork showing website content management, plugin integration, and SEO settings.",
    industry: "Technology • 6 months",
    description:
      "Transformed a struggling tech startup into an industry leader through comprehensive CMS Development strategy.",
    image:
      ppc1,
    stats: [
  ...
  "EcoShop": {
    title: "Creative flat vector illustration of CMS setup for blogs, e-commerce, and business websites.",
  ...
  "HealthPlus Clinic": {
    title: "Professional concept of CMS development showing cloud-based content updates and teamwork collaboration.",
    industry: "Healthcare • 5 months",
    description:
      "Improved patient acquisition and local CMS Development rankings for a healthcare provider using optimized content strategy.",
    image:
      ppc3,
    stats: [
...
const advantages = [
  {
    title: "Easy Content Updates and Publishing",
    description:
      "A CMS allows your team to add blog posts, update products, or refresh pages in real time without coding knowledge.",
    icon: TrendingUp,
  },
  {
    title: "Scalable and Customizable Architecture",
    description:
      "From small startups to global enterprises, a CMS grows with your business, supporting new features and increased traffic.",
    icon: BarChart3,
  },
  {
    title: "User-friendly interface for Non-Technical Users",
    description:
      "Intuitive dashboards make content management accessible to everyone, reducing reliance on developers.",
    icon: Search,
  },
  {
    title: "CMS Development Optimization Features",
    description:
      "Built-in tools like meta tags, sitemaps, and clean URLs boost your website’s visibility on search engines.",
    icon: Handshake,
  },
];
...
const solutions = [
  {
    ...
    description:
      "We build bespoke CMS platforms from the ground up, tailored to your specific workflows, branding, and objectives.",
    icon: ShoppingCart,
    points: [
      "Custom CMS Development, descriptions, and CTAs.",
      "applications for Custom CMS Development search engine hierarchy.",
  ...
  },
  {
    ...
    description:
      " Leverage the world’s most popular CMS with our custom WordPress themes, plugins, and optimizations for blogs, portfolios, or e-commerce.",
    icon: Building2,
    points: [
      "enhancing customer engagement or internal productivity.",
      "iOS and Android Custom CMS Development for efficient indexing.",
      "Scalable Solutions: Systems that grow with your business.",
    ],
  },
  {
    title: "Drupal, Joomla, Shopify, and Magento Setups",
    description:
      "We specialize in configuring and customizing these powerful platforms for complex websites and online stores.",
    icon: MapPin,
    points: [
      "designed to scale with Custom CMS Development.",
      "finance, Local Listings: Consistent NAP and citations.",
      "Custom CMS Development Engage your local audience.",
    ],
  },
  {
    title: "CMS Migration and Upgrades",
    description: "Seamlessly transition from outdated systems to modern CMS platforms without losing data or CMS Development rankings.",
    icon: Link2,
    points: [
      "Custom CMS Development AI-targeted high-authority sites.",
  ...
  },
  {
    ...
    description:
      " Extend your CMS with custom plugins or modules to add unique features like booking systems, analytics, or payment gateways.",
    icon: HelpCircle,
    points: [
      "Optimize Content Structure: Custom CMS Development.",
      "FAQ & Structured Data: Custom CMS Development search chances.",
      "Improve Visibility: Custom CMS Development and AI searches.",
    ],
  },
  {
    title: "CMS Integration with Third-Party Tools",
    description:
      "Connect your CMS with CRMs (e.g., Salesforce), ERPs, email marketing platforms, or social media for a unified workflow.",
    icon: Mic,
    points: [
      "software and third-party tools Conversational queries.",
      "Content Reformatting: Custom CMS Development content.",
      "Custom CMS Development Optimized for Siri, Alexa.",
    ],
  },
];
...
const steps = [
  {
    ...
    description:
      "We start by understanding your business, audience, and goals to recommend the best CMS solution.",
    icon: Target,
  },
  {
    number: "2",
    title: "Design Mockups and UI/UX",
    description:
      "Our designers create visually appealing, user-friendly interfaces that enhance engagement and navigation.",
    icon: Search,
  },
  {
    number: "3",
    title: "CMS Selection or Custom Build",
    description:
      "Based on your needs, we choose an open-source platform or develop a custom CMS from scratch.",
    icon: Zap,
  },
  {
    number: "4",
    ...
    description:
      " Our developers code the CMS, integrate third-party tools, and ensure seamless functionality.",
    icon: Globe,
  },
  {
    number: "5",
    ...
    description:
      "We rigorously test for performance, security, and compatibility before launching your website.",
    icon: BarChart3,
  },
  {
    number: "6",
    ...
    description:
      "After launch, we provide ongoing updates, troubleshooting, and training to keep your CMS running smoothly.",
    icon: Award,
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Engagement can spike quickly—sometimes within days—especially through social media and email campaigns. However, CMS Development results from our Content Marketing Service typically take 3 to 6 months to fully develop. This timeline allows for consistent content creation, keyword optimization, and link-building, which are essential for sustainable search engine ranking growth.",
  },
  {
    question: "What sets Diglip7’s Content Marketing Service apart?",
    answer:
      "Diglip7 offers a data-driven, audience-first content strategy tailored to your brand voice and goals. Our Content Marketing Service stands out through in-depth keyword research, professional storytelling, and multi-platform distribution. We focus not just on visibility but on conversion—turning readers into loyal customers. Our personalized approach ensures measurable results that align with your business objectives.",
  },
  {
    question: "How much does it cost?",
    answer:
      "Pricing for our Content Marketing Service varies based on your specific goals, content volume, and distribution channels. We offer flexible packages to fit different budgets—from startups to enterprise-level brands. Transparent pricing, no hidden fees, and scalable options make it easy to grow with us. Book a free consultation to get a custom quote tailored to your needs.",
  },
  {
...
function Cms_dev() {
  ...
  const seoPackages = [
    {
      ...
      duration: "/month",
      features: [
        "CMS consultation & requirement analysis",
        "Setup and configuration of CMS (WordPress, Joomla, or similar)",
        "Custom theme setup & basic design",
    ...
    },
    {
      ...
      popular: true,
      features: [
        "Custom CMS development & module creation",
    ...
    },
    {
      ...
      duration: "/month",
      features: [
        "Full-scale CMS development & management",
        "Custom CMS features & automation",
        "Multi-site & multi-language setup",
        "Weekly progress reporting & strategy calls",
        "Dedicated CMS development team",
  ...
  const ppcServices = [
    ...
    { icon: DollarSign, title: "CMS Development Campaign Management", description: "Full management of Google Ads, Bing Ads, and social campaigns." },
    ...
    <div className="bg-white w-full">
      ...
      <div className=" pt-20 bg-gradient-to-r from-purple-100 via-pink-100 to-white min-h-screen flex flex-col justify-center items-center px-6 md:px-16 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center max-w-6xl gap-10">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              {/* <button className="bg-blue-700 hover:bg-blue-800 text-white px-6 py-3 rounded-full font-semibold flex items-center gap-2 shadow-md transition-transform hover:scale-105">
                    Get Free CMS Development Audit <ArrowRight size={18} />
                  </button> */}
              <a href="/contact">
                <motion.button
          ...
          >
            <img
              src={seo2}
              alt="Modern illustration of a CMS interface with drag-and-drop website builder and dashboard tools."
      ...
      <div className="bg-gray-50">
        ...
        <div className="py-16 px-6 md:px-12 lg:px-20">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 mb-20">
            <motion.img
              src={ppc4}
              alt="Developers working on custom CMS development with code editor and design preview screens."
            ...
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Why CMS Development is the Best Investment for Your Business
              </h2>
              <p className="text-gray-700 mb-4">
                CMS development  <span className="font-semibold text-blue-700">DigLip7</span>,
                enables easy content management, improved website performance, and enhanced SEO. It streamlines workflows and boosts user engagement, making it a smart investment for long-term digital growth and ROI.
          ...
          <div className="bg-white py-16 px-6 md:px-12 lg:px-20 text-center">
            ...
            <div className="max-w-4xl mx-auto mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                Our Proven CMS Development Process
              </h2>
              <p className="text-gray-600 mt-3">
                At DigLip7, our CMS development process ensures efficient, scalable, and user-friendly websites. We begin with requirement analysis and strategy planning, followed by design, CMS setup, customization, and testing. Continuous optimization and support guarantee seamless content management, enhanced website performance, and a superior user experience.
              </p>
            </div>
          ...
          <div className="bg-gray-50 py-16 px-6 md:px-12 lg:px-20">
            <div className="max-w-6xl mx-auto text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                Proven CMS Development Success Stories
              </h2>
              <p className="text-gray-600 mt-3">
                Real results from real businesses that trusted <span className="font-semibold text-teal-600">DigLip7</span> with their CMS Development journey.
              </p>
            ...
            >
              ...
              <div className="flex-1 space-y-4">
                ...
                <p className="text-sm text-gray-600">
                  Transformed a struggling tech startup into an industry leader through advanced CMS Development.
                </p>
        ...
        {/* CMS Development Services Section */}
        <div className="bg-white py-16 px-6 md:px-12 lg:px-20">
          <div className="max-w-6xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Our CMS Development Services</h2>
            <p className="text-gray-600 mb-10">
              Pay-per-click services designed to maximize ROI and drive targeted traffic.
            </p>
        ...
        {/* CMS Development Pricing Section */}
        <div className="bg-gray-50 py-16 px-6 md:px-12 lg:px-20">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">CMS Development Packages Designed for Every Stage</h2>
            <p className="text-gray-600 mb-10">
              Choose the perfect CMS Development package that fits your business needs and budget.
            </p>
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-6">
              <p className="text-gray-600 leading-relaxed text-sm sm:text-base lg:text-lg">
                A Content Management System (CMS) is the backbone of a modern website, empowering businesses to create, manage, and publish digital content without needing advanced technical skills. From blogs and e-commerce stores to corporate websites, a CMS simplifies content updates, ensures scalability, and enhances user experience.
              </p>
              <p className="text-gray-600 leading-relaxed text-sm sm:text-base lg:text-lg">
                At DigLip7, we specialize in CMS development, delivering tailored solutions that drive online success.
              </p>
            </div>
        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          >
            ...
            <p className="text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8">
              In today’s fast-paced digital landscape, businesses need websites that are easy to update, CMS Development-friendly, and secure. A CMS enables non-technical teams to manage content efficiently while providing developers with the flexibility to customize functionality. There are two primary types of CMS solutions:
            </p>
            <p className="text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8">
              Custom CMS
              Built from scratch to meet unique business needs, offering full control and flexibility.
            </p>
            <p className="text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed mb-6 sm:mb-8">
              Open-Source CMS
              Platforms like WordPress, Drupal, Joomla, Shopify, and Magento provide ready-to-use frameworks with extensive plugin ecosystems
            </p>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base lg:text-lg">
                  At{" "}
                  <span className="font-semibold text-teal-700">Experienced Team of Developers and Designers</span>,
                  Our skilled professionals bring years of experience in building high-performance CMS websites.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-teal-700 leading-relaxed text-sm sm:text-base lg:text-lg">
                  Scalable, CMS Development-Ready, and Secure Solutions{" "}
                  <span className="font-semibold text-[#c89d5a]">
                    Every CMS we develop is optimized for search engines, built to scale, and fortified with advanced security measures.
                  </span>
                  Expertise in Open-Source and Custom CMS Platforms
                  From WordPress to bespoke systems, we master the tools that best suit your needs.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base lg:text-lg">
                  ...
                  Our iterative process ensures transparency, timely delivery, and alignment with your business goals.
                </p>
              </motion.div>
            </div>
          </motion.div>
      ...
      <section className="bg-white py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 text-sm sm:text-base lg:text-lg max-w-3xl mx-auto leading-relaxed">
            Investing in professional CMS development unlocks a range of benefits for businesses, entrepreneurs, and content creators:
          </p>
        </motion.div>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-teal-50/30 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          <FloatingElement>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-teal-700 mb-4 sm:mb-6">
              CMS Development Services Offered by DigLip7
            </h2>
          </FloatingElement>
