...
function Home() {
  ...
  ">
      ...
      >
        <div className="bg-gradient-to-r from-purple-400 via-purple-300 to-pink-400 shadow-2xl py-4 sm:py-5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
              {/* Left Section - Icon, Timer and Title */}
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 flex-1 text-center sm:text-left">
                <div className="flex items-center space-x-2 shrink-0">
                  <div className="w-11 h-11 sm:w-12 sm:h-12 bg-white/30 border border-white/40 rounded-xl flex items-center justify-center backdrop-blur-sm shadow-sm shrink-0">
                    <Zap className="w-6 h-6 sm:w-7 sm:h-7 text-yellow-300 fill-yellow-300" />
                  </div>
                  <div className="bg-red-500 text-white text-xs sm:text-sm font-bold px-3 py-1.5 rounded-full flex items-center space-x-1.5 animate-pulse shadow-sm">
                    <Clock className="w-3.5 h-3.5 text-white" />
                    <span>Limited Time</span>
                  </div>
                  <div className="hidden sm:block text-white text-sm lg:text-base font-medium">
                    Expires in:{" "}
                ...
                <div className="text-center sm:text-left">
                  <h4 className="text-white text-lg sm:text-xl lg:text-2xl font-bold tracking-tight leading-tight">
                    FREE $2,500 Marketing Audit
                  </h4>
                  <p className="text-purple-100 text-sm sm:text-base hidden md:block">
              ...
              <div className="flex items-center gap-3 shrink-0">
                <a href="/contact">
                  <button className="flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 bg-gradient-to-r from-teal-600 to-teal-700 text-white text-base sm:text-lg font-semibold rounded-full shadow-2xl hover:shadow-teal-500/50 transition-all duration-300 transform hover:scale-105">
                ...
                <button
                  ...
                  className="w-11 h-11 bg-gradient-to-r from-teal-700 to-teal-900 hover:from-teal-800 hover:to-teal-950 text-white rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 transform hover:scale-105 shrink-0"
                  title="Close banner"
